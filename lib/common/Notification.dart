...
class DataDaseService {

}
abstract class NotificationService {
  Function firebaseCloudMessagingListeners(BuildContext context) {
...
//    update(token);
    ...
    firebaseMessaging.subscribeToTopic("hutech");
...
//      FlutterAppBadger.updateBadgeCount(int.tryParse(msg['data']['badge_count']));
...
//      FlutterAppBadger.updateBadgeCount(int.tryParse(msg['badge_count']));
      increaseBadge(int.tryParse(msg["page_id"]));
